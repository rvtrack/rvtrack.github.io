/**
 * 2011.01.24 - Changed $ references to use mirage.jQuery - This is so Pulse can work
 * with the custom namespace created for the Mirage RapidWeaver theme by NimbleHost.
 * 
 * jQuery.pulse
...
/**
 * 2011.01.24 - Changed jQuery reference to use mirage.jQuery - This is so Color animations
 * can work with the custom namespace created for the Mirage RapidWeaver theme by NimbleHost.
 * 
 */
