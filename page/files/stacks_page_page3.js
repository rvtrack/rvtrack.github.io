...
stacks.stacks_in_4485417_page3 = {};
stacks.stacks_in_4485417_page3 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_4485417_page3 > .container').parentsUntil('.stacks_top').css('overflow', 'visible');
		$('.stacks_top').css({'overflow' : 'visible'});
	
});

return stack;})(stacks.stacks_in_4485417_page3);
stacks.stacks_in_4485421_page3 = {};
stacks.stacks_in_4485421_page3 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){

	var gal_col = $('#stacks_in_4485421_page3 .gallery_column');
	...
	baguetteBox.run('#stacks_in_4485421_page3 .gallery_wrapper', {
		  captions: true,       // true|false|callback(element) - Display image captions
		  buttons: 'auto',      // 'auto'|true|false - Display buttons
		  async: false,         // true|false - Load files asynchronously
		  preload: 2,           // [number] - How many files should be preloaded from current image
...
return stack;})(stacks.stacks_in_4485421_page3);
